...
resultado = ollama.generate(model="gemma3:12b", prompt="Bom dia")
...
while True:
    ...
    tempo_resposta = time()
    resultado = ollama.generate(model="gemma3:12b", prompt=pergunta) 
    ...
    with open('teste_1.txt', 'a', encoding="utf-8") as arquivo:
