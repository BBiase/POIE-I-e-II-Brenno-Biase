...
resultado = ollama.generate(model="llama3:latest", prompt="Bom dia")
...
while True:
    ...
    tempo_resposta = time()
    resultado = ollama.generate(model="llama3:latest", prompt=pergunta) 
    ...
    with open('Saida_ICL_Aprimorada.txt', 'a', encoding="utf-8") as arquivo:
