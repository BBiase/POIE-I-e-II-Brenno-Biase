...
os.environ['OPENAI_API_KEY'] = "CHAVE API OPEN AI AQUI"
...
resultado = ollama.generate(model=model_name, prompt="Bom dia")
...
while True:
    ...
    tempo_resposta = time()
    resultado = ollama.generate(model=model_name, prompt=pergunta) 
...
def obter_contexto(pergunta, dados, index, threshold=1.0, qtd = 5):
